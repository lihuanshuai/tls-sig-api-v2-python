...
class TLSSigAPIv2:
    ...
    def __hmacsha256(self, identifier, curr_time, expire, base64_userbuf=None):
        ...
        return base64.b64encode(hmac.new(six.ensure_binary(self.__key),
                                         six.ensure_binary(raw_content_to_be_signed),
    ...
    def __gen_sig(self, identifier, expire=180*86400, userbuf=None):
        ...
        sig_cmpressed = zlib.compress(six.ensure_binary(raw_sig))
